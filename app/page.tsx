...
const basePath = '/kolo-mee-stinablis-1775102290114';
...
export default function Home() {
  ...
  const products = [{ n: 'Product 1', d: 'Kolo Putih - Our signature white Kolo Mee, tossed in a light and savory sauce, topped with juicy chicken and crispy shallots.', icon: 'domain' }, { n: 'Product 2', d: 'Kolo Merah - Our spicy red Kolo Mee, cooked in a rich and flavorful sauce, topped with tender beef and crunchy fried onions.', icon: 'architecture' }, { n: 'Product 3', d: 'Kolo Kicap - Our sweet and savory Kolo Mee, stir-fried in a mixture of soy sauce and spices, served with a side of fresh vegetables.', icon: 'chair' }, { n: 'Product 4', d: 'Wantan - Our delicate wantan noodles, served in a light broth or stir-fried with your choice of sauce, filled with tender pork or shrimp.', icon: 'eco' }, { n: 'Product 5', d: 'Mee Pok - Our classic yellow noodles, served dry or in a soup, tossed with a variety of ingredients such as pork, chicken, or vegetables.', icon: 'precision_manufacturing' }];
    ...
    <div className="min-h-screen bg-surface text-on-surface font-body">
      ...
      <section id="about" className="py-24 bg-surface">
        <div className="max-w-7xl mx-auto px-8">
          ...
          <p className="text-on-surface-variant text-lg max-w-3xl mb-12">Kolo Mee Stinablis is a reputable food establishment dedicated to serving the most authentic and delicious Kolo Mee dishes. Our story began with a passion for Sarawak\'s iconic cuisine, and we have been perfecting our recipes to bring you the best Kolo Mee experience.</p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div><h4 className="font-bold text-primary">Vision</h4><p className="text-sm text-on-surface-variant">To be the leading Kolo Mee brand, renowned for our exceptional taste, quality, and customer satisfaction.</p></div>
            <div><h4 className="font-bold text-primary">Mission</h4><p className="text-sm text-on-surface-variant">To consistently provide our customers with the most authentic and delicious Kolo Mee dishes, while promoting the rich culinary heritage of Sarawak.</p></div>
            <div><h4 className="font-bold text-primary">haha</h4><p className="text-sm text-on-surface-variant">Quality is our top priority. We use only the freshest ingredients and adhere to strict cooking standards to ensure every dish that leaves our kitchen meets the highest quality standards.</p></div>
            <div><h4 className="font-bold text-primary">lmao</h4><p className="text-sm text-on-surface-variant">Customer satisfaction is at the heart of everything we do. We strive to provide exceptional service, listen to our customers\' feedback, and continuously improve to meet their evolving needs and preferences.</p></div>
          </div>
        </div>
      </section>
